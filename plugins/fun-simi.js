...
let handler = async (_0xeb7f32, { text: _0x1ff34a, command: _0x3cba8e, args: _0x34fed4, usedPrefix: _0x62b6d9 }) => {
  ...
  if (!_0x1ff34a) return conn['reply'](_0xeb7f32['chat'], 'Hola: ' + _0xeb7f32['pushName'] + ' Soy Droid Tú Bebesit@ 😍 ¿Quieres chatear? Responde con el comando junto con tu mensaje.', _0xbfd118, _0xeb7f32);
