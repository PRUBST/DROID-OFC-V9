...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} GANASTE 🥳, TE LLEVAS +4999 EXP` : isTie ? 'EL JUEGO TERMINÓ EN UN EMPATE 😹' : `TURNO DE @${room.game.currentTurn.split('@')[0]}`}
`.trim()
