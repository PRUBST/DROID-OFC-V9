...
if (!db.data.chats[m.chat].modohorny && m.isGroup) throw '*LOS COMANDOS +18 ESTÁN DESACTIVADOS EN ÉSTE GRUPO, si el administrador de sea activarlos use el comando/enable modohorny*'
