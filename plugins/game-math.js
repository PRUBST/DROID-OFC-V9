let handler = async (m, { conn, args, usedPrefix, command }) => {  
  ...
  let modes = {  
    ...
    extremo: [-999999, 999999, -999999, 999999, '*/', 99999, 1900],  
    imposible: [-99999999999, 99999999999, -99999999999, 999999999999, '*/', 45000, 2500],  
    imposible2: [-999999999999999, 999999999999999, -999, 999, '/', 30000, 3500]  
  }  
