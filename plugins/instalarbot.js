...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  try {
    if (!existsSync(sessionPath)) {
      return await conn.sendMessage(m.chat, {text: '*[❗] La carpeta Session-activa o existe o está vacía.*'}, {quoted: m});
    }
  ...
  await conn.sendMessage(m.chat, {text: `🧑🏻‍💻 Operación completada: los archivos/caché del servidor han sido eliminados con éxito, proporcionando un mejor rendimiento.`}, {quoted: m});
};
