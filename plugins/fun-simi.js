...
let handler = async (_0xeb7f32, { text: _0x1ff34a, command: _0x3cba8e, args: _0x34fed4, usedPrefix: _0x62b6d9 }) => {
  ...
  try {
    ...
    try {
      ...
      let senderTag = `@${_0xeb7f32.sender.split('@')[0]}`; // Obtiene la etiqueta @ junto con el nombre de usuario
      let _0x200bd0 = await _0x560386('http://api.brainshop.ai/get?bid=153868&key=rcKonOgrUFmn5usX&uid=' + senderTag + '&msg=' + _0x4c57d7[0][0][0]),
      ...
      _0xeb7f32.reply(_0xf07ea0[0][0][0]);
    } catch {
      ...
      let _0x3d337f = await _0x560386('https://violetics.pw/api/utility/simsimi?apikey=beta&text=' + _0xa0735c[0][0][0]),
        _0x397994 = await _0x3d337f.json();
      let _0x4a5cb0 = _0x397994.result;
      let _0x30135e = await _0x74f12c('' + _0x4a5cb0, { to: 'es', autoCorrect: true });
      _0xeb7f32.reply(_0x30135e.text);
    }
  }
};

handler.help = ['simi', 'bot'].map(_0x532f0e => `${_0x532f0e} <teks>`);
handler.tags = ['fun'];
